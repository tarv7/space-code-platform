...
ActiveRecord::Schema.define(version: 2021_06_20_183254) do
  ...
  create_table "contracts", force: :cascade do |t|
    ...
    t.check_constraint "origin_id <> destiny_id", name: "check_same_planets"
  ...
  create_table "travel_routes", force: :cascade do |t|
    ...
    t.index ["origin_id", "destiny_id"], name: "index_travel_routes_on_origin_id_and_destiny_id", unique: true
