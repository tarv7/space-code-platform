...
thales = Pilot.find_or_create_by(certification: "6844690", name: 'Thales Augusto', age: 24, credits: 10, location: calas)
talysson = Pilot.find_or_create_by(certification: "5748306", name: 'Talysson de Oliveira', age: 22, credits: 20, location: aqua)
...
Contract.find_or_create_by(payload: minerals, payload_weight: 20, origin: aqua, destiny: demeter, value: 10, state: 'processing', pilot: thales)
Contract.find_or_create_by(payload: water, payload_weight: 25, origin: andvari, destiny: demeter, value: 10, state: 'finished', pilot: cassiano)
