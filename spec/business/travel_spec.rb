  ...
  describe '#call!' do
    ...
    context 'when is fail' do
      ...
      context 'when there is no route between origin and destination' do
        ...
        it_behaves_like 'raise exception and keep contract in accepted state',
                        [Travel::TravelError, 'There is no route between origin and destination']
      end
      ...
      context 'when the gas level is below cost' do
        ...
        it_behaves_like 'raise exception and keep contract in accepted state',
                        [Travel::TravelError, 'Fuel level is low']
      end
      ...
      context 'when the ship cannot support the payload' do
        ...
        it_behaves_like 'raise exception and keep contract in accepted state',
                        [Travel::TravelError, 'Payload weight is greater than ship capacity']
      end
